"""Write the model-written prompt set on a GPU and save it next to this file.
    ...
    modal run examples/grpo/write_prompts_modal.py                    # ~500 prompts, A10G, a few minutes
    modal run examples/grpo/write_prompts_modal.py --seeds 400 --per-seed 6 --out examples/grpo/prompts.jsonl
