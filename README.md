...
wai.holdout_size(
    0.05, rows=before, after=after
)  # the paired sd measured off a previous eval, no model
wai.holdout_size(0.05, sd_task=0.38)  # or the sd read off a delta_report interval
