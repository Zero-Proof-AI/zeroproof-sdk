"""simulate(): the run loop, spec loading, knob resolution."""
...
def simulate(agent: Any = None, *, spec: Any = None,
    ...
    # Writes the progress file before inspection or backend construction
    # so callers see it immediately.
    ...
    if not model_version_tag:
        if agent is not None and callable(agent) and not isinstance(agent, str):
            ...
            try:
                from .generate.agents import parse_backend_spec as _pbs, \
